...
CoffeeBot::CoffeeBot(void) : BaseRobot(999) {
...
int CoffeeBot::numconnected(void) {
  return this->connections.size();
}

void CoffeeBot::reset(void) {
  this->prev_motion.zeros();
}

void CoffeeBot::send(const vec &motion) {
